 ...
 */
@Mojo(
        name = "test-compile-extras",
        defaultPhase = LifecyclePhase.GENERATE_SOURCES,
        requiresDependencyResolution = ResolutionScope.COMPILE,
        threadSafe = true
)
public final class ProtocTestCompileExtrasMojo extends AbstractProtocCompileMojo {
    ...
    public static final class ExtraPlugin {
        ...
        protected void addProtocBuilderParameters(final Protoc.Builder protocBuilder, AbstractProtocCompileMojo parent, File extraOutputBaseDirectory) {
            ...
            final File buildOutputDirectory = new File(parent.project.getBuild().getOutputDirectory());
